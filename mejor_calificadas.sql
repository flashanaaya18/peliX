-- Plantilla para añadir nuevas películas a la categoría "Mejor Calificadas" en Pelix
--
-- INSTRUCCIONES:
...
-- `category`: Para esta sección, debe ser siempre 'top_rated'.

-- PLANTILLA:
INSERT INTO `movies` (`id`, `title`, `overview`, `poster_path`, `backdrop_path`, `youtube_id`, `category`) VALUES (999007, 'Mi Película Mejor Calificada', 'Descripción de una película aclamada por la crítica en Pelix.', '/poster_aclamada.jpg', '/fondo_aclamada.jpg', 'ID_VIDEO_YOUTUBE', 'top_rated');